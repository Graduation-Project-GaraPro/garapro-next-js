...
const systemMetrics = [
  {
    ...
    details: {
      ...
      processes: '156 active',
      topProcesses: ['nginx', 'node', 'mysql', 'redis'],
      utilization: {
        user: '35%',
        system: '8%',
        idle: '57%'
  ...
  },
  {
    ...
    details: {
      ...
      topProcesses: ['node', 'mysql', 'nginx', 'redis'],
      memoryMap: {
        applications: '8.2 GB',
        system: '2.1 GB',
        cache: '2.1 GB',
  ...
  },
  {
    ...
    details: {
      ...
      readSpeed: '120 MB/s',
      writeSpeed: '85 MB/s',
      topDirectories: ['/var/log', '/home', '/tmp', '/usr'],
      diskHealth: 'Good',
  ...
  },
  {
    ...
    details: {
      ...
      dropped: '12',
      connections: '1,234',
      topConnections: ['HTTP', 'HTTPS', 'SSH', 'MySQL'],
      latency: '2.3ms'
    }
  }
]
          ...
          return (
            <Dialog key={metric.title} open={selectedMetric?.title === metric.title} onOpenChange={() => setSelectedMetric(null)}>
              ...
              <DialogContent className="max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle>System Metric Details</DialogTitle>
                  <DialogDescription>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleRefreshMetrics} disabled={isLoading}>
                    {isLoading ? (
                      <>
