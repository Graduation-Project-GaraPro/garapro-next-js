    ...
    return (
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center pt-1">
              ...
              <span className={`text-xs ${data.growthRate >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {Math.abs(data.growthRate)}% vs previous period
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(data.previousPeriodRevenue)}</div>
            <p className="text-xs text-muted-foreground pt-1">
