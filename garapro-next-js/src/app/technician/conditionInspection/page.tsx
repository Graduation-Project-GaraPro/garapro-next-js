...
type TaskStatus = "Pending Inspection" | "Approval" | "In Progress";
          ...
          <div className="flex items-center justify-between mb-4 gap-4">
            ...
            <div className="flex items-center space-x-2 bg-white/40 rounded-xl p-2 shadow-sm border border-gray-200">
              ...
              <div className="flex space-x-2">
                {(["all", "Pending Inspection", "Approval", "In Progress"] as const).map((status) => (
                  <button
                    key={status}
                  ...
                  >
                    ...
                    <div className="relative p-6">
                      ...
                      {vehicle.status === "Pending Inspection" ? (
                        <div className="flex items-center justify-between mb-4 gap-4">
                          {/* <button className="w-full py-3 bg-gradient-to-r from-blue-400/50 to-purple-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg flex items-center justify-center gap-2 cursor-not-allowed opacity-50"> */}
                          <button className="w-full py-3 bg-gradient-to-r from-blue-400/50 to-purple-700 hover:from-blue-600/40  text-white font-semibold rounded-xl transition-all duration-300 shadow-lg flex items-center justify-center gap-2 cursor-not-allowed opacity-60">
                        ...
                        <div className="flex items-center justify-between mb-4 gap-4">
                          ...
                          <button
                            onClick={() => router.push(`conditionInspection/checkCondition?id=${vehicle.id}`)} // Navigate to checkCondition page
                            className="w-full py-3 bg-gradient-to-r from-blue-400/70 to-cyan-800 hover:from-blue-700/70 hover:to-cyan-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
                          >
                            <Zap className="w-5 h-5" />
                            Start Inspection
                          </button>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-amber-600">
                      {assignedVehicles.filter(v => v.status === "Pending Inspection").length}
                    </div>
