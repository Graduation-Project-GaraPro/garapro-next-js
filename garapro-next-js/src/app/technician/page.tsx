...
export default function TechnicianHomePage() {
  ...
  return (
    <div className="space-y-6 max-h-[85vh] overflow-y-auto rounded-2xl">

      {/* Welcome Section */}
      <div className="bg-white px-10 py-6 rounded-lg shadow-md mb-2 ">
        ...
        {images.map((image, index) => (
          <img
            ...
            onError={(e) => {
              ...
              target.src = `https://via.placeholder.com/800x640/cccccc/666666?text=Image+${index + 1}`;
            }}
          />
        ))}
