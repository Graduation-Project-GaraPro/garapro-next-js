  ...
  return (
    <div className="bg-[url('/images/image9.png')] bg-cover bg-no-repeat h-[640px] p-4 rounded-lg shadow-md ">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800 font-semibold">{vehicleInfo?.issue}</p>
                          </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-3 max-h-[68vh] overflow-y-auto rounded-xl rounded-scroll rounded-xl bg-white/70 px-8 py-4">
