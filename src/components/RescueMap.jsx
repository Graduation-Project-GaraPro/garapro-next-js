...
const RescueMap = ({ location, technicianLocation }) => {
  const [mapLoaded, setMapLoaded] = useState(false);

  useEffect(() => {
    // Trong môi trường thực tế, đây sẽ là nơi khởi tạo bản đồ với Google Maps hoặc Mapbox
  ...
  const userLocation = location.lat && location.lng ? location : { lat: location.latitude || 10.762622, lng: location.longitude || 106.660172 };
      ...
      {!mapLoaded ? (
        ...
        <div className="h-full w-full relative">
          ...
          <div className="absolute inset-0 bg-blue-50 overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" style={{top: `${userLocation.lat * 0.1}%`, left: `${userLocation.lng * 0.1}%`}}>
            ...
            {technicianLocation && (
              <div className="absolute" style={{top: `${technicianLocation.lat * 0.1}%`, left: `${technicianLocation.lng * 0.1}%`}}>
