...
import useSubmitRepairForm from '@/hooks/useSubmitRepairForm';
import { Plus, Camera } from 'lucide-react';

export default function SubmitRepairRequest() {
  const [repairRequests, setRepairRequests] = useState([]);
  const { formData, setFormData, errors, setErrors, handleChange, handleSubmit, reset } = useSubmitRepairForm({
    vehicle: '',
    licensePlate: '',
    issue: '',
    description: '',
      ...
      <form onSubmit={onSubmitForm} className="space-y-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border ${errors.vehicle ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
            required
          />
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border ${errors.licensePlate ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
            required
          />
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border ${errors.issue ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
            required
          />
        ...
        <div>
          ...
          <select
            ...
            className={`w-full px-4 py-3 border ${errors.priority ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
          >
